...
When the AeoKit action router is available, call aeokit_api_catalog with a short resource noun such as "prompts", then call aeokit_api_call with the returned operationId. Do not inspect repository code or use shell commands to perform AeoKit product operations.
